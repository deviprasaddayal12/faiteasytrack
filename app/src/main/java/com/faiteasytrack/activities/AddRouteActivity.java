...
public class AddRouteActivity extends BaseActivity implements View.OnClickListener, OnMapReadyCallback {
...
//                    isRouteExists = true;
        ...
        public void onCancelled(@NonNull DatabaseError databaseError) {
            ...
            hideProgressDialog();
            DialogUtils.showSorryAlert(AddRouteActivity.this, databaseError.getMessage(), null);
        }
    };
...
//                            routeId = DateUtils.createRouteId();
                        ...
                        Intent driverIntent = new Intent(AddRouteActivity.this, AddDriverActivity.class);
...
//                            routeId = DateUtils.createRouteId();
                        ...
                        Intent vehicleIntent = new Intent(AddRouteActivity.this, AddVehicleActivity.class);
...
//            routeName = (etRouteName.getText().toString());
    ...
    private ValueEventListener addRouteEventListener = new ValueEventListener() {
        ...
        public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
            ...
            hideProgressDialog();
            DialogUtils.showCheersAlert(AddRouteActivity.this, "Route added successfully.",
                    new Runnable() {
                        @Override
                        public void run() {
                            onBackPressed();
        ...
        public void onCancelled(@NonNull DatabaseError databaseError) {
            ...
            hideProgressDialog();
            DialogUtils.showSorryAlert(AddRouteActivity.this, "" + databaseError.getMessage(),
                    new Runnable() {
                        @Override
                        public void run() {
                            onBackPressed();
