...
public class NAddVehicleActivity extends BaseActivity implements View.OnClickListener {
    ...
    private ValueEventListener findVehicleEventListener = new ValueEventListener() {
        ...
        public void onCancelled(@NonNull DatabaseError databaseError) {
            ...
            hideProgressDialog();
            DialogUtils.showSorryAlert(NAddVehicleActivity.this, databaseError.getMessage(), null);
        }
    };
    ...
    private ValueEventListener addVehicleEventListener = new ValueEventListener() {
        ...
        public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
            ...
            hideProgressDialog();
            DialogUtils.showCheersAlert(NAddVehicleActivity.this, "Vehicle added successfully.",
                    new Runnable() {
                        @Override
                        public void run() {
                            onBackPressed();
        ...
        public void onCancelled(@NonNull DatabaseError databaseError) {
            ...
            hideProgressDialog();
            DialogUtils.showSorryAlert(NAddVehicleActivity.this, "" + databaseError.getMessage(),
                    new Runnable() {
                        @Override
                        public void run() {
                            onBackPressed();
        ...
        DialogUtils.showSorryAlert(this, "Seems as if all drivers are occupied." +
                ...
                new Runnable() {
                    ...
                    public void run() {
                        ...
                        Intent driverIntent = new Intent(NAddVehicleActivity.this, NAddDriverActivity.class);
        ...
        DialogUtils.showSorryAlert(this, "Seems as if all routes are occupied." +
                ...
                new Runnable() {
                    ...
                    public void run() {
                        ...
                        Intent routeIntent = new Intent(NAddVehicleActivity.this, NAddRouteActivity.class);
