...
public class AddDriverActivity extends BaseActivity implements View.OnClickListener {
    ...
    private ValueEventListener findDriverEventListener = new ValueEventListener() {
        ...
        public void onCancelled(@NonNull DatabaseError databaseError) {
            ...
            hideProgressDialog();
            DialogUtils.showSorryAlert(AddDriverActivity.this, databaseError.getMessage(), null);
        }
    };
        ...
        DialogUtils.showSorryAlert(this, "Seems as if all vehicles are occupied." +
                ...
                new Runnable() {
                    ...
                    public void run() {
                        ...
                        Intent vehicleIntent = new Intent(AddDriverActivity.this, AddVehicleActivity.class);
        ...
        DialogUtils.showSorryAlert(this, "Seems as if all routes are occupied." +
                ...
                new Runnable() {
                    ...
                    public void run() {
                        ...
                        Intent routeIntent = new Intent(AddDriverActivity.this, AddRouteActivity.class);
    ...
    private void addNewDriver() {
        ...
        driverModel.setUid_(firebaseUser.getUid());
        driverModel.setName_(firebaseUser.getDisplayName());
        driverModel.setPhoneNumber_(firebaseUser.getPhoneNumber());
    ...
    private ValueEventListener addDriverEventListener = new ValueEventListener() {
        ...
        public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
            ...
            hideProgressDialog();
            DialogUtils.showCheersAlert(AddDriverActivity.this, "Driver added successfully.",
                    new Runnable() {
                        @Override
                        public void run() {
                            onBackPressed();
        ...
        public void onCancelled(@NonNull DatabaseError databaseError) {
            ...
            hideProgressDialog();
            DialogUtils.showSorryAlert(AddDriverActivity.this, "" + databaseError.getMessage(),
                    new Runnable() {
                        @Override
                        public void run() {
                            onBackPressed();
