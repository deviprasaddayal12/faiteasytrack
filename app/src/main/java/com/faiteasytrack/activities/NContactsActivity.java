...
public class NContactsActivity extends BaseActivity implements View.OnClickListener, SwipeRefreshLayout.OnRefreshListener,
    ...
    public void setUpRecycler() {
        ...
        adapterContacts = new ContactsAdapter(this, contactModels, new ContactsAdapter.OnContactSelectedListener() {
            ...
            public void onContactSelected(int position, ContactModel contactModel) {
                ...
                ViewUtils.makeToast(NContactsActivity.this, "Requesting...");
            }
        });
