...
public class AddVendorActivity extends BaseActivity implements View.OnClickListener {
    ...
    private ValueEventListener findVendorEventListener = new ValueEventListener() {
        ...
        public void onCancelled(@NonNull DatabaseError databaseError) {
            ...
            hideProgressDialog();
            DialogUtils.showSorryAlert(AddVendorActivity.this, databaseError.getMessage(), null);
        }
    };
    ...
    private ValueEventListener addVendorEventListener = new ValueEventListener() {
        ...
        public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
            ...
            hideProgressDialog();
            DialogUtils.showCheersAlert(AddVendorActivity.this, "Vendor added successfully.",
                    new Runnable() {
                        @Override
                        public void run() {
                            onBackPressed();
        ...
        public void onCancelled(@NonNull DatabaseError databaseError) {
            ...
            hideProgressDialog();
            DialogUtils.showSorryAlert(AddVendorActivity.this, "" + databaseError.getMessage(),
                    new Runnable() {
                        @Override
                        public void run() {
                            onBackPressed();
